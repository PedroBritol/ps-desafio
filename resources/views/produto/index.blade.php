    ...
    <script>
        ...
        $('#modal-detalhes').on('show.bs.modal', function(event) {
            ...
            $.getJSON(url, (resposta) => {
                ...
                $("#detalhes-nome").val(resposta[0].name);
                $("#detalhes-preço").val(resposta[0].price);
                $("#detalhes-descricao").val(resposta[0].description);
                $("#detalhes-quantidade").val(resposta[0].amount);
                $("#detalhes-categoria").val(resposta[1].category_name);
                $("#detalhes-imagem").attr('src', '/storage/' + resposta[0].photo);
            });
        })
